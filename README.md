...
Usage examples are provided in the [scripts/](https://github.com/zgornel/ParSitter.jl/tree/master/scripts) and [test/languages/](https://github.com/zgornel/ParSitter.jl/tree/master/test/languages) directories.

### Prerequisites

ParSitter requires a recent version of the tree-sitter CLI (≥ v0.25) and compiled parsers for the languages you want to use.

Check out the [documentation](https://zgornel.github.io/ParSitter.jl/dev) for more information on how to install and use the library.
